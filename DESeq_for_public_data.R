...
write.csv(RESDRP000768,file= "RES_DRP000768.csv")
write.csv(RESERP003465,file= "RES_ERP003465.csv")
write.csv(RESSRP022869,file= "RES_SRP022869.csv")
write.csv(RESSRP041017,file= "RES_SRP041017.csv")
write.csv(RESSRP045409,file= "RES_SRP045409.csv")
write.csv(RESSRP048912,file= "RES_SRP048912.csv")
